<<<<<<< Updated upstream:connect_objects.py
...
def showWindow():
    ...
    #def set_X(x1):
    #    isChecked = ui.x_check.checkState() 
    #    if isChecked:
    #        t.axis = "X"
#
    ##snap to y side of object
    #def set_Y(y1):
    #    isChecked = ui.y_check.checkState() 
    #    if isChecked:
    #        t.axis = "Y"
#            
    ##snap to y side of object
    #def set_Z(z1):
    #    isChecked = ui.z_check.checkState() 
    #    if isChecked:
    #        t.axis = "Z"
    ...
    def apply():
        ...
        if t.isPlane:
            ...
            cmds.bevel(c1, ch=True, rn=False, po=1, ns=1, js=True, ed=1)
            cmds.delete(c1)
...
if __name__ == "__main__":
    window = showWindow()
>>>>>>> Stashed changes:ConnectViaCurveTool/connect_objects.py
